...
def CNN():
    ...
    cnn2 = Conv1D(filters=16, kernel_size=3, activation='relu')(cnn1)
...
history = m.fit(x_train_multi_transposed, y_train_multi, batch_size=32, epochs=100, validation_split=0.2, shuffle=True, callbacks=[model_checkpoint_callback])
